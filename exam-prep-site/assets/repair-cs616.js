(function () {
  ...
  if (classicalAndZk) {
    ...
    const smallZkOperations = [
      ...
      "要从 3t≡5 (mod 11) 中单独留下 t，需要 3 的逆元。手写两条 Euclid 式：11=3×3+2；3=1×2+1。反代：1=3−2=3−(11−3×3)=4×3−11，所以 3⁻¹≡4 (mod 11)。",
    ...
    const realZkOperations = [
      ...
      "接下来从 904≡697t (mod 991) 中解出 t。需要 697⁻¹ mod 991。这里适合使用一张扩展 Euclid 系数表：从初始化行 (991,0)、(697,1) 开始，每行同时更新余数 r 和 697 的系数 d。",
      "系数表最后得到余数 1 与系数 d=−300。因此 1≡−300×697 (mod 991)，所以 697⁻¹≡−300≡691 (mod 991)。乘回检查：697×691=486×991+1。",
