(function () {
  ...
  if (classicalAndZk) {
    ...
    const affineOperations = [
      ...
      "把两组映射代入 c≡am+b (mod 676)：542≡312a+b；127≡219a+b。两条式子上下对齐，方便相减。",
      "第一式减第二式。左边 542−127=415；右边 (312−219)a+(b−b)=93a。因此 415≡93a (mod 676)。这一步的目的只是消去 b。",
      "题目给 93⁻¹≡189。使用前先检查：93×189=17577=26×676+1，所以乘积模 676 的余数确实是 1。",
      "在 415≡93a 两边同乘 189：a≡415×189=78435。再写 78435=116×676+19，所以 a=19。",
      "把 a=19 代回较顺手的第一式：542≡312×19+b。移项得 b≡542−5928=−5386。再加 8×676，得到 b=22。",
      "检查 ma：19×312+22=5950=8×676+542，所以 ma 确实加密为 uw。",
      "检查 il：19×219+22=4183=6×676+127，所以 il 确实加密为 ex。两组都通过后才写最终密钥 (19,22)。"
    ];
