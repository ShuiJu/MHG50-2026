        ...
        extraExamples: [
          {
            ...
            steps:[
              ...
              "只相乘指数 8、4 和 1 对应的项。5¹³≡16×4×5=320 mod 23。",
          ...
          },
          {
            ...
            result:"x≡8 mod 15。范围 0≤x<15 内的答案是 8。"
          }
        ],
        practice: {
          q: "6 在 mod 26 下有逆元吗？",
...
steps: [
          ...
          },
          {
            ...
            steps: [
              ...
              "题目已经给出 93⁻¹≡189 mod 676，本题不要求重新求该逆元。先验证给定值：93×189=17577=26×676+1，所以乘积模 676 的余数确实是 1。两边同乘 189：a≡415×189 mod 676。415×189=415×(200−11)=83000−4565=78435。又有 78435=116×676+19，所以 a=19。",
        ...
        parts: [
          ...
          },
          {
            ...
            steps: [
              ...
              "iii) 攻击使用 composite modulus 下的不同平方根。由 R²≡Y² mod N，可得 N 整除 (R−Y)(R+Y)。若 Y≠±R mod N，两个因子分别整除这两个括号。计算 gcd 可以得到其中一个因子。",
          ...
          },
          {
            ...
            steps: [
              ...
              "题目给 5P=(4,6)、P=(13,2)，所以 6P=5P+P。用同一顺序相减，斜率分子是 6−2=4，分母是 4−13=−9≡8 mod 17。求 8⁻¹ mod 17：17=2×8+1，所以 1=17−2×8，8 的系数 −2 对应标准余数 15。验证 8×15=120=7×17+1。于是 λ=4×15=60≡9 mod 17。再算 x=9²−4−13=64≡13，y=9×(4−13)−6=−87≡15。因此 6P=(13,15)。",
...
(() => {
  ...
  add("cs616", 1, [{
    ...
    steps: [
      ...
      "代入 y=3。x≡21×(−5)=−105 mod 26。−105+5×26=25。",
  ...
  add("cs616", 3, [{
    ...
    steps: [
      ...
      "求 d≡e⁻¹ mod 40。先算 40=13×3+1。改写得 1=40−13×3，所以 3 的 Bézout 系数是 −13。把 −13 加一个模数 40，得到标准余数 27。因此 d=27。验证：3×27=81=2×40+1。",
      "签名为 s=m^d mod n=9²⁷ mod 55。快速平方：9²≡26，9⁴≡16，9⁸≡36，9¹⁶≡31。",
      "27=16+8+2+1，所以 s≡31×36×26×9 mod 55。逐次取模得到 31×36≡16，16×26≡31，31×9≡4。",
      "验证计算 s^e mod n=4³=64 mod 55=9，等于消息 m。"
    ],
    result: "私钥指数 d=27，签名 s=4，验证值 4³ mod 55=9。"
  }, {
    title: "Rabin 的两个不同平方根怎样给出因子",
    prompt: "模 n=77 有 x=13、y=20，且 x²≡y² mod 77，但 x不等于±y mod 77。恢复因子。",
    steps: [
      ...
      "条件 x不等于±y 很重要。若 x≡y，第一项 gcd 可能是 n；若 x≡−y，第二项 gcd 可能是 n，不能得到非平凡分解。"
    ],
  ...
  add("cs616", 4, [{
    ...
    steps: [
      "倍点斜率为 λ=(3x₁²+a)(2y₁)⁻¹ mod p。代入得分子 3×25+2=77≡9 mod 17，分母 2。",
      "求 2⁻¹ mod 17。先算 17=8×2+1。改写得 1=17−8×2，所以 2 的 Bézout 系数是 −8。把 −8 加一个模数 17，得到标准余数 9。因此 2⁻¹ mod 17=9。验证：2×9=18=1×17+1。故 λ≡9×9=81≡13 mod 17。",
      "计算 x₃=λ²−2x₁≡13²−10=159≡6 mod 17。",
      "计算 y₃=λ(x₁−x₃)−y₁≡13(5−6)−1=−14≡3 mod 17。",
  ...
  add("cs616", 5, [{
    ...
    result: "(1+2y²)(2+y)≡y+4y² in Z₅[y]/(y³+1)。"
  }]);
...
(() => {
  ...
  exam[0].parts[1].states = [
    ...
    {after:2,title:"当前方程组",headers:["明文值 x","密文值 y","方程 mod 676"],rows:[["312","542","542≡312a+b"],["219","127","127≡219a+b"]]},
    {after:3,title:"消去 b 后的状态",headers:["左边相减","右边相减","当前同余式"],rows:[["542−127=415","(312−219)a=93a","415≡93a mod 676"]]},
    {after:4,title:"求出 a 后的状态",headers:["93⁻¹","415×189","mod 676","a"],rows:[["189","78435","19","19"]]},
    {after:5,title:"求出 b 后的状态",headers:["回代式","整数值","mod 676","b"],rows:[["542−19×312","−5386","22","22"]]},
    {after:7,title:"两组明密文回代",headers:["输入","19x+22","mod 676","应得密文"],rows:[["312","5950","542","uw=542"],["219","4183","127","ex=127"]]}
  ];
  ...
  exam[2].parts[2].states = [
    ...
    {after:8,title:"X=6P+6Y 的斜率状态",headers:["分子","分母","分母逆元","λ"],rows:[["14−15≡16","1−13≡5","5⁻¹=7","16×7≡10 mod 17"]]},
...
(() => {
  ...
  Object.assign(findExample("cs616", 0, "用 CRT 合并两个余数条件"), {
    ...
    steps: [
      ...
      "求逆元 y₁，使 5y₁≡1 mod 3。因为 5 mod 3=2 且 2×2≡1，所以 y₁=2。",
      "求逆元 y₂，使 3y₂≡1 mod 5。因为 3×2=6≡1，所以 y₂=2。此时两行 CRT 表已经完整。",
  ...
  depth.cs616.learn[0].extraExamples.push({
    ...
    steps: [
      ...
      "分别约简。M₁ mod 233=50，M₂ mod 181=43，M₃ mod 241=239≡−2。",
    ...
    states: [
      ...
      {after:3,title:"步骤 3 后的 CRT 表",headers:["i","m_i","a_i","M_i","M_i mod m_i"],rows:[["1","233","216","43621","50"],["2","181","50","56153","43"],["3","241","179","42173","239≡−2"]]},
