...
steps: [
          ...
          },
          {
            ...
            steps: [
              ...
              "根 (a_p=108, a_q=62)：公式要求先算 a_q−a_p，所以这里是 62−108，而不是 108−62。代入得到 u≡(62−108)×433≡(−46)×433 (mod 547)。先把 −46 化为标准余数：−46+547=501，所以 u≡501×433 (mod 547)。计算 501×433=216933=396×547+321，因此 u≡321 (mod 547)，取 u=321。再代回 x=a_p+523u：x=108+523×321=108+167883=167991。检查减法方向：167991 mod 523=108，且 167991 mod 547=62，两条目标同余式都成立。若只把差值反成 108−62、却仍使用 x=a_p+523u，则会得到 u=226、x=118306，而 118306 mod 547=154≠62，所以那种写法不满足第二条条件。108−62 并非永远不能用：若把参数式同时改成 x=a_p−523u，那么会得到同一个解；不能只反转差值而保留其余公式不变。",
              ...
              "逐个验算候选根。`x² mod N` 的意思就是 x² 除以 N 后的余数，可以用计算器直接得到；为了让结果可以手工核对，再把同一件事写成带余除法 x²=qN+r，其中 q 是商、r 是余数，因此 r=x² mod N。例如 163068²=26591172624=92949×286081+229755，所以 163068² mod 286081=229755。其余三个候选也按同一格式检查，四个余数都必须等于 radicand 0x3817b=229755。",
