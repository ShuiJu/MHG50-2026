...
steps: [
          ...
          },
          {
            ...
            steps: [
              ...
              "题目已经给出 93⁻¹≡189 (mod 676)，本题不要求重新求该逆元。先验证：93×189=17577=26×676+1，所以 93×189≡1 (mod 676)。在 415≡93a (mod 676) 两边同乘 189，得到 a≡415×189 (mod 676)。计算 415×189=78435=116×676+19，所以 a≡19 (mod 676)，取标准代表元 a=19。",
...
(() => {
  ...
  exam[0].parts[1].states = [
    ...
    {after:4,title:"用题给逆元求 a",headers:["题给的完整逆元式","两边同乘 189","整数除法","结论"],rows:[["93⁻¹≡189 (mod 676)","a≡415×189 (mod 676)","78435=116×676+19","a≡19 (mod 676)"]]},
    {after:5,title:"回代求 b",headers:["完整回代式","整数值","归一化","结论"],rows:[["b≡542−19×312 (mod 676)","−5386","−5386+8×676=22","b≡22 (mod 676)"]]},
    {after:7,title:"两组明密文回代",headers:["输入 m","整数计算","完整模检查","应得密文"],rows:[["312","19×312+22=5950","5950≡542 (mod 676)","uw=542"],["219","19×219+22=4183","4183≡127 (mod 676)","ex=127"]]}
  ];
